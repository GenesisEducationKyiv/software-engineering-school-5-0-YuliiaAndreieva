...
const (
	WeatherService_GetWeatherByCity_FullMethodName = "/weather.WeatherService/GetWeatherByCity"
)
...
func (c *weatherServiceClient) GetWeatherByCity(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (*WeatherResponse, error) {
...
func (UnimplementedWeatherServiceServer) GetWeatherByCity(context.Context, *WeatherRequest) (*WeatherResponse, error) {
...
func _WeatherService_GetWeatherByCity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetWeatherByCity(ctx, req.(*WeatherRequest))
	}
